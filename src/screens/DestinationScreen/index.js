...
function ZakazScreen() {
    ...
    const onCord = (data, details) => {
        ...
        setLocation(prevState => ({...prevState, cena: distanceMOWBKK.toFixed(2)}));
    };
    console.log(cena);
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <ScrollView style={{width: '100%', height: '100%'}} bounces={false}>
                        ...
                        <TouchableOpacity>
                            <View style={styles.card}>
                                <View style={styles.view2}>
                                    ...
                                    <Text
                                        style={[styles.title, {fontSize: 30, fontWeight: '800'}]}>
                                        {t('От 149 Р')}
                                        <Svg
                ...
                <View
                    ...
                    <Text style={{fontSize: 30}}>
                        {formatter.format(cena || 0).replace('₽', '₽')}
                    </Text>
                    <Button
                        title={t('отправить')}
