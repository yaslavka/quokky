...
function Navbar(){
    ...
    const Busines = <Svg width={30} height={30} fill="#335616"
        focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="BusinessIcon" tabIndex="-1"
        title="Business">
        <Path
    ...
    const Payments = <Svg width={30} height={30} fill="#335616"
        focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="PaymentIcon" tabIndex="-1"
        title="Payment">
    ...
    const Help =
        <Svg width={30} height={30} fill="#335616"
             focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="SupportIcon" tabIndex="-1"
             title="Support">
    ...
    return(
        <Drawer.Navigator initialRouteName="TabNavigator" drawerContent={props => <DrawerContent{...props}/>}>
            <Drawer.Screen
                name="TabNavigator"
