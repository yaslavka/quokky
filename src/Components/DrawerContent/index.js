...
import {View, Text, Image, SafeAreaView, StyleSheet, Linking, Pressable, Alert, Switch} from 'react-native'
            ...
            {userInfo && (
                <SafeAreaView style={styles.container}>
                    <DrawerContentScrollView {...props}>
                        <View style={{paddingLeft: 10, backgroundColor:colors.placeholder, paddingVertical: 10, borderRadius: 20}}>
                            <View style={{flexDirection: "row", alignItems: "center",}}>
                                ...
                                <View style={{alignItems: "flex-end", marginLeft: 15}}>
                                    <Text style={[styles.textcolor, {fontWeight: "bold", fontSize: 18}]}>
                            ...
                            <View style={{flexDirection:"row", marginTop: 10, alignItems: "center", justifyContent: "space-evenly"}}>
                                <View style={{alignItems: "center"}}>
                                    ...
                                    <Text style={[styles.textcolor, {fontWeight: "bold", fontSize: 20}]}>
                                        Balance
                                    </Text>
                                </View>
                                <View style={{alignItems: "center"}}>
                    ...
                    <DrawerItem
                        ...
                        icon={()=>(
                            <Svg width={30} height={30} fill="#335616"
                                 focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ExitToAppIcon"
                                 tabIndex="-1" title="ExitToApp">
